...
void draw()
{
  ...
  polarArray(50, 10, width/2, height/2, counter);
  polarArray(100, 4, width/2, height/2, 2*-counter);
  polarArray(150, 2, width/2, height/2, counter);
  polarArray(70, 1, width/2, height/2, -counter);
//  for ( int i = 5 ; i < 100 ; i++ )  {
